...
var Script = React.createClass({
  ...
  loadScript: function () {
    ...
    fb.once('value', function (snapshot) {
      if (!snapshot.val()) {
        var newLine = fb.child('lines').push({
          type: 'scene'
        });
        fb.set({
          title: '',
    ...
    window.onunload = function () {
      if (_.keys(this.state.script.lines).length <= 2) fb.remove();
    }.bind(this);
  },
  ...
  getSuggestion: function (lineIndex, fromValue) {
    ...
    var iterate = function (index) {
      ...
      if (line.type == type && line.text && line.text.length > text.length && line.text.toUpperCase().indexOf(text) === 0) suggestions.push(line.text.toUpperCase());
      if (index == lineIndex) passed = true;
      if (passed && suggestions.length) return;
      if (line.next && this.state.script.lines[line.next]) iterate(line.next);
    }.bind(this);
      ...
      case 38:
        ...
        if (prevIndex) {
          if (event.metaKey || event.ctrlKey) {
            // [a, b, C, d] => [a, C, b, d]
            // A points to C
            if (prevPrevIndex) this.firebaseRefs.script.child('lines/' + prevPrevIndex).update({
              next: index
            });else this.firebaseRefs.script.update({
              firstLine: index
            });
            // C points to B
            var newNext = line.next;
            this.firebaseRefs.script.child('lines/' + index).update({
              next: prevIndex
            });
            // B points to D
            if (line.next) this.firebaseRefs.script.child('lines/' + prevIndex).update({
              next: newNext
            });else this.firebaseRefs.script.child('lines/' + prevIndex + '/next').remove();
      ...
      case 40:
        ...
        if (line.next) {
          if (event.metaKey || event.ctrlKey) {
            ...
            // A points to C
            if (prevIndex) this.firebaseRefs.script.child('lines/' + prevIndex).update({
              next: line.next
            });else this.firebaseRefs.script.update({
              firstLine: line.next
            });
            ...
            // C points to B
            this.firebaseRefs.script.child('lines/' + line.next).update({
              next: index
            });
            // B points to D
            if (newNext) this.firebaseRefs.script.child('lines/' + index).update({
              next: newNext
            });else this.firebaseRefs.script.child('lines/' + index + '/next').remove();
  ...
  render: function () {
    ...
    if (this.state.script && this.state.script.lines && this.state.script.firstLine) {
      ...
      lines = /*#__PURE__*/React.createElement("h1", {
...
var Line = React.createClass({
      ...
      case 39:
        ...
        if (~['character', 'scene'].indexOf(this.props.line.type) && cursorPos(event.target) >= event.target.textContent.length) {
          ...
          if (suggestion = this.props.getSuggestion(this.props.index)) {
            this.firebaseRefs.line.update({
              text: this.props.line.text + suggestion
            }, function () {
  ...
  focus: function (atEnd) {
    if (atEnd) placeCaretAtEnd(this.refs.text.getDOMNode());else this.refs.text.getDOMNode().focus();
  },
  ...
  render: function () {
    ...
    if (this.props.readonly) {
      ...
      line = /*#__PURE__*/React.createElement(ContentEditable, {
        ref: "text",
    ...
    })), this.state.commenting && /*#__PURE__*/React.createElement(ContentEditable, {
      ref: "commentBox",
...
var ContentEditable = React.createClass({
  ...
  stripPaste: function (e) {
    ...
    var item = _.findWhere(e.clipboardData.items, {
      type: 'text/plain'
    });
...
var Nav = React.createClass({
  ...
  render: function () {
    if (!this.state.script) return /*#__PURE__*/React.createElement("div", null);
    if (this.state.script.title !== undefined) document.title = 'Screenwriter: ' + (this.state.script.title || 'Untitled');
    var editing = this.state.script.lines && this.state.script.lines[this.props.editingIndex] || {};
    if (this.state.open == 'print') {
      var characters = [];
      _.each(_.uniq(_.map(_.pluck(_.where(this.state.script.lines, {
        type: 'character'
      }), 'text'), function (character) {
        return character && character.toUpperCase();
      })), function (character) {
        if (character) characters.push(/*#__PURE__*/React.createElement("option", {
          key: character
        }, character));
      });
    }
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "navbar navbar-inverse navbar-fixed-top hidden-print",
      role: "navigation"
    }, /*#__PURE__*/React.createElement("div", {
      className: "container"
    }, /*#__PURE__*/React.createElement("ul", {
      className: "nav navbar-nav btn-block row"
    }, /*#__PURE__*/React.createElement("li", {
      className: "col-sm-6 col-xs-12 navbar-btn dropdown"
    }, /*#__PURE__*/React.createElement("div", {
    ...
    })))), this.state.open == 'print' && /*#__PURE__*/React.createElement("div", {
      ...
      onClick: this.print
    }, "Print Script"), /*#__PURE__*/React.createElement("div", {
      className: "popover-content"
    }, /*#__PURE__*/React.createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/React.createElement("textarea", {
      placeholder: "Author(s)",
      value: this.state.script.authors,
      ...
      value: this.state.script.leftAddress,
      onChange: this.handleChange.bind(this, 'leftAddress'),
      className: "form-control",
      readOnly: this.props.readonly
    })), /*#__PURE__*/React.createElement("div", {
      className: "form-group"
      ...
      value: this.state.script.rightAddress,
      onChange: this.handleChange.bind(this, 'rightAddress'),
      className: "form-control",
      readOnly: this.props.readonly
    })), /*#__PURE__*/React.createElement("div", {
      className: "form-group"
      ...
      value: ""
    }, "-- Highlighter --"), characters))))), this.props.readonly || /*#__PURE__*/React.createElement("li", {
      className: 'col-sm-6 col-xs-12 dropdown ' + (this.state.g == 'line' && 'open')
    }, /*#__PURE__*/React.createElement("a", {
      onClick: this.toggle.bind(this, 'line')
    }, /*#__PURE__*/React.createElement("i", {
      className: "glyphicon glyphicon-align-center"
    }), /*#__PURE__*/React.createElement("span", {
      className: "uppercase"
    }, " ", editing.type || 'Line Type', " "), /*#__PURE__*/React.createElement("b", {
      className: "caret"
    })), this.state.open == 'line' && /*#__PURE__*/React.createElement("div", {
      className: "popover bottom",
      style: {
        display: 'block'
      }
      ...
      className: "list-group uppercase popover-content text-center"
    ...
    }, this))))))), /*#__PURE__*/React.createElement("header", {
      className: "visible-print"
    }, /*#__PURE__*/React.createElement("p", {
      className: "uppercase"
    }, this.props.script.title), this.props.script.authors && /*#__PURE__*/React.createElement("p", null, "by"), /*#__PURE__*/React.createElement("p", null, this.props.script.authors), this.state.highlight && /*#__PURE__*/React.createElement("p", {
      className: "character-highlighted"
    }, "Character: ", this.state.highlight.toUpperCase()), /*#__PURE__*/React.createElement("address", {
      className: "text-left"
    }, this.props.script.leftAddress), /*#__PURE__*/React.createElement("address", {
...
var Home = React.createClass({
  ...
  render: function () {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "text-center"
    }, /*#__PURE__*/React.createElement("h1", null, "Screenwriter"), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("a", {
      className: "btn btn-primary",
      onClick: this.newScript
    }, /*#__PURE__*/React.createElement("i", {
      className: "glyphicon glyphicon-plus"
    }), " New Script"), "\xA0", /*#__PURE__*/React.createElement(Link, {
      className: "btn btn-primary",
      to: "/demo"
    }, "Demo Script")), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("a", {
      className: "btn btn-default",
      href: "https://github.com/ProLoser/screenwriter"
    }, /*#__PURE__*/React.createElement("img", {
      src: "github-icons/GitHub-Mark-32px.png",
      alt: "Github"
    }), " Source Code"))), /*#__PURE__*/React.createElement("h3", null, "Collaborate:"), /*#__PURE__*/React.createElement("p", null, "Share your custom URL with friends to collaborate or add ", /*#__PURE__*/React.createElement("code", null, "/view"), " to the end for ", /*#__PURE__*/React.createElement("strong", null, "readonly"), " mode!"), /*#__PURE__*/React.createElement("h3", null, "Shortcuts:"), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Enter"), " Insert new line", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "(Shift+)Tab"), " Cycle through line types", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "Up/Down"), " Move through lines", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "Cmd/Ctrl+Up/Down"), " Reorder lines", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "Right"), " Autocomplete the character or scene", /*#__PURE__*/React.createElement("br", null)), /*#__PURE__*/React.createElement("h3", null, "Comments:"), /*#__PURE__*/React.createElement("p", {
      className: "help"
    }, "Hover over a line and click comment button ", /*#__PURE__*/React.createElement("i", {
      className: "glyphicon glyphicon-comment",
      style: commentStyles
    })), /*#__PURE__*/React.createElement("h3", null, "Notes:"), /*#__PURE__*/React.createElement("p", null, "Scripts are not secure, if someone can figure out your URL, they can edit it. Print to PDF if you want a permanent copy."));
  }
});
var App = React.createClass({
  displayName: "App",
  render: function () {
    return /*#__PURE__*/React.createElement(RouteHandler, null);
  }
});
...
var routes = /*#__PURE__*/React.createElement(Route, {
  handler: App
}, /*#__PURE__*/React.createElement(DefaultRoute, {
  handler: Home
  ...
  name: "scriptAction",
  path: "/:scriptId/:action",
  handler: Script
}));
ReactRouter.run(routes, function (Handler) {
  React.render(/*#__PURE__*/React.createElement(Handler, null), document.getElementById('container'));
});
